...
# App
set(_qgc_default_app_name "无人船地面控制软件")
if(NOT DEFINED QGC_APP_NAME OR QGC_APP_NAME STREQUAL "QGroundControl")
    set(QGC_APP_NAME "${_qgc_default_app_name}" CACHE STRING "App Name" FORCE)
else()
    set(QGC_APP_NAME "${QGC_APP_NAME}" CACHE STRING "App Name")
endif()
unset(_qgc_default_app_name)
set(QGC_TARGET_NAME "QGroundControl" CACHE STRING "Internal Target Name")
